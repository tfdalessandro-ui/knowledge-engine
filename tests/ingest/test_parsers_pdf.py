"""PDF parsing test -- gated behind OSE_ENABLE_PDF_TESTS=1 because Docling's
...
pytestmark = pytest.mark.skipif(
    os.environ.get("OSE_ENABLE_PDF_TESTS") != "1",
    reason="PDF parsing downloads ML models on first use; set OSE_ENABLE_PDF_TESTS=1 to run this test",
)
